...
const tractorLines = [
  ...
  },
  {
    id: 'quantum',
    name: 'Quantum',
    description: t('case.tractores.type2.desc'),
  ...
  },
  {
    id: 'puma',
    name: 'Puma',
    description: t('case.tractores.type3.desc'),
  ...
  },
  {
    id: 'steiger',
    name: 'Steiger',
    description: t('case.tractores.type4.desc'),
  ...
  },
  {
    ...
    description: t('case.tractores.type5.desc'),
  ...
  },
  {
    ...
    description: t('case.tractores.type6.desc'),
