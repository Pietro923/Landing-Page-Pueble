...
export default function TrabajaConNosotros() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Limpiamos el formulario después de un pequeño retraso
      setTimeout(() => {
        setFormData({
          nombre: "",
          apellido: "",
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-0 shadow-xl">
          ...
          <CardContent>
            ...
            >
              ...
              <input type="hidden" name="_subject" value="Nueva postulación laboral" />
              <input type="hidden" name="_template" value="table" />
              <input type="hidden" name="_captcha" value="false" />
              <input type="hidden" name="_next" value="" /> {/* Dejarlo vacío o con la URL actual */}
              <input type="hidden" name="_autoresponse" value="Gracias por tu postulación. Hemos recibido tu información y pronto nos pondremos en contacto contigo." />
