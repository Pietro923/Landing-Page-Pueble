...
export default function Servicios() {
  ...
  // Controla la precarga de animaciones
  useEffect(() => {
    // Pequeño tiempo para asegurar que los componentes estén montados
  ...
  // Variante de animación común para todas las secciones
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-red-900 via-black to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto px-4 relative">
        {/* Título y descripción - Siempre visible sin depender de animaciones */}
        <motion.div
        ...
        {/* Servicios destacados - Con visibilidad inicial */}
        <motion.div
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="bg-white/10 backdrop-blur-sm border-0 hover:bg-white/15 transition-colors duration-300 text-white h-full">
        ...
        {/* AFS Connect - Con visibilidad incluso durante la carga */}
        <div className="mb-16 relative bg-white/5 backdrop-filter backdrop-blur-sm rounded-lg overflow-hidden">
          <motion.div
            variants={sectionVariants}
            initial="hidden"
            animate={isLoaded ? "visible" : "hidden"}
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {/* Carrusel de imágenes con opacidad mínima inicial */}
              <motion.div
                initial={{ opacity: 0.7 }}
                animate={{ opacity: 1 }}
                  ...
                  <CarouselContent className="-ml-4">
                    {imagesafs.map((image, index) => (
                      <CarouselItem key={index} className="pl-4 basis-full">
                        <div className="relative overflow-hidden rounded-2xl shadow-2xl aspect-[4/4]">
                          <img 
                            src={image}
                            alt={`Imagen ${index + 1}`}
        ...
        {/* JCB Live Link - Con visibilidad incluso durante la carga */}
        <div className="mb-16 relative bg-white/5 backdrop-filter backdrop-blur-sm rounded-lg overflow-hidden">
          <motion.div
            variants={sectionVariants}
            initial="hidden"
        ...
        {/* Testimonios - Con visibilidad inicial */}
        <div className="mb-16 bg-white/5 backdrop-filter backdrop-blur-sm rounded-lg overflow-hidden">
          <motion.div
            variants={sectionVariants}
            initial="hidden"
            animate={isLoaded ? "visible" : "hidden"}
